...
```{r vars, echo=FALSE}
startTime <- "2013-04-15 00:00:00"
endTime <- "2013-04-22 12:00:00"
```
...
d <- d + scale_y_log10(breaks=c(0.1,0.3,0.6), limits=c(0.05, 1.5))
d <- d + geom_hex()
...
rpc3 <- logdata2[logdata2$"key" %in% c("Latency CIAPI.ListTradeHistory","Latency CIAPI.GetMarketInformation","Latency CIAPI.ListSpreadMarkets"), ]
