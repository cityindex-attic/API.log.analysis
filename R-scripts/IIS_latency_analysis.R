...
folder <- "C:/Dev/API.log.analysis/data/201209-201301/"
datafile <- paste0(folder, '201209-201301-79.125.25.36_requests.log')
...
qplot(requests_trade$"time-taken", binwidth=5, xlim = c(10, 300),
      main="Trade latency histogram",  
      xlab="Latency")