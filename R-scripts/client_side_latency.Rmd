...
startTime <- "2012-06-13 08:00:00"
data_url <- URLencode(paste("http://metrics.labs.cityindex.com/GetRecords.ashx?Application=CIAPILatencyCollector&StartTime=",startTime, sep = ''))
```
