...
logdata = read.table('sample_data/IIS/rdb-srv-webl25_ex120408.log')
...
points(sessionCreate_latency_ts["2012-04-08 00:00:00::2012-04-08 04:30:00"], col="black", cex=0.05)
points(sessionDelete_latency_ts["2012-04-08 00:00:00::2012-04-08 04:30:00"], col="blue", cex=0.01)
points(clientandtradingaccount_latency_ts["2012-04-08 00:00:00::2012-04-08 04:30:00"], col="red", cex=0.01)
points(cfdmarkets_latency_ts["2012-04-08 00:00:00::2012-04-08 04:30:00"], col="brown", cex=0.01)
points(spreadmarkets_latency_ts["2012-04-08 00:00:00::2012-04-08 04:30:00"], col="green", cex=0.01)
legend(strptime("2012-04-08 03:30:00", "%Y-%m-%d %H:%M:%S"), 4000, c("Session create", "Session delete", "ClientAndTradingAccount", "CFD markets (100 mkts)", "Spread markets (0 mkts)"), pch=c(1,1,1,1,1), col=c("black", "blue", "red", "brown", "green"), cex=0.8)
...
points(clientandtradingaccount_latency_ts, col="blue", cex=0.01)
...
points(cfdmarkets_latency_ts, col="brown", cex=0.01)
