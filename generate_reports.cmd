...
logparser.exe -i:IISW3C file:queries\summary-chart.sql?InputIISLogs=%InputIISLogs%+OutputReport=reports\summary.gif -o:CHART -chartType:ColumnClustered -config:queries\chart_config.js -groupSize:1024x768
